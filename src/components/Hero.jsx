...
import {  tobacco_cup, smoke3, smoke4 } from "../assets";
  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className={`flex-1 flex ${styles.flexCenter}  relative`}>
        <img src={tobacco_cup} alt="billing" className=" absolute z-[5]" />
        <img src={smoke3} alt="billing" className=" absolute z-[6]" />
        <img src={smoke4} alt="billing" className=" relative z-[4]" />
